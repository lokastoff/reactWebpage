...
export const Features =()=>{
    return(
        <section className = 'featuresSection mt-0'>
            <div className='pageapdding px-[25rem]'>
                <div className='containerLarge mx-auto w-full max-w-[73.25rem]'>
                    <div className='paddingVertical py-[6rem]'>
                        <div className='featuresComponents overflow-visible'>
                            <div className='contentHeading mx-auto max-w-[672px] text-center'>
                                <div className='marginBottom mb-[2rem] text-center'>
                                    <motion.div initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration:1.2}} className='animWrap overflow-hidden'>
                                        <p className=' my-0 font-extrabold text-6xl text-[#1e1e20]'>Some of our features</p>
                                    </motion.div>
                                    <motion.div initial={{opacity:0}} whileInView={{opacity:1}} transition={{duration:1.2}} className='animWrap overflow-hidden'>
                                        <p className=' my-0 font-extrabold text-6xl text-[#1e1e20]'>that will help you</p>
                                    </motion.div>  
                                </div>
                            ...
                            <div className='features-grid grid items-stretch justify-items-stretch content-stretch justify-stretch grid-cols-3 grid-rows-1 gap-y-[4rem] gap-x-[4rem]'>
