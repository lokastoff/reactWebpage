...
export const About = () =>{
    return (
        <section className='sectionAbout mt-0 h-[1872px] bg-[#121313]'>
                ...
                <div className='containerLarge mx-auto w-full max-w-[73.25rem]'>
                    <div className='paddingVertical px-0'>
                        <div className='aboutComponent'>
                            <div className='aboutGrid1 grid grid-rows-1 grid-cols-[1.75fr_1.25fr] gap-y-[16px] gap-x-[16px] items-stretch justify-items-stretch content-stretch justify-stretch pt-[10rem]'>
                                ...
                                <motion.div initial={{opacity:0,x:50}} whileInView={{opacity:1,x:0}} transition={{duration:1.5}} className='aboutItem1 items-center'>
                                    <div className='contentHeading'>
                                        <div className='marginBottom mb-[2rem]'>
                                            <div className='animWrap overflow-hidden'>
                                                <h2 className='my-0 font-extrabold text-[3.75rem] text-[#f4f4f4]'>Easy and</h2>
                                            </div>
                                            <div className='animWrap overflow-hidden'>
                                                <h2 className='my-0 font-extrabold text-[3.75rem] text-[#f4f4f4]'>effortless way</h2>
                                            </div>
                                            <div className='animWrap overflow-hidden'>
                                                <h2 className='my-0 font-extrabold text-[3.75rem] text-[#f4f4f4]'>to connect with</h2>
                                            </div>
                                            <div className='animWrap overflow-hidden'>
                                                <h2 className='my-0 font-extrabold text-[3.75rem] text-[#f4f4f4]'>your team</h2>
                                            </div>
                                        </div>
                                        <div className='marginBottom mb-[2rem]'>
                                    ...
                                    <div className='marginBottom'>
                                        <button className='py-[16px] px-[24px] font-medium text-[16px] text-[#f4f4f4a3] rounded-[32px] border-[1px] border-[#f4f4f429] duration-200 ease-in-out transition-colors hover:text-white hover:border-white'>Learn more about Hush</button>
                                    </div>
                                </motion.div>
                            </div>
                            <div className='aboutGrid2 grid gap-[16px] grid-cols-[1.25fr_1.75fr] grid-rows-1 items-stretch justify-items-stretch content-stretch justify-stretch pt-[10rem]'>
                                <motion.div initial={{opacity:0,x:-50}} whileInView={{opacity:1,x:0}} transition={{duration:1.5}} className='aboutItem2  content-center justify-center'>
                                    <div className='contentheading'>
                                        <div className='marginBottom mb-[2rem]'>
                                            <div className='animWrap overflow-hidden'>
                                                <h2 className='font-extrabold text-[3.75rem] text-[#f4f4f4]'>  
                                                    Tons of
                                                </h2>
                                            </div>
                                            <div className='animWrap overflow-hidden'>
                                    ...
                                    <div className='marginBottom'>
                                        <button className=' py-[16px] px-[24px] text-[18px] font-medium text-[#f4f4f4a3] rounded-[32px] border-[1px] border-[#f4f4f429] duration-200 ease-in-out transition-colors hover:text-white hover:border-white'>
